...
window.AGENT_PROMPT = [
  ...
  "",
  "Live ingest (default — appears on the site in seconds, no babysitting):",
  "  1. Output a JSON array of specimen objects: id, section, name, description, creator, tags, tweaks, code.",
