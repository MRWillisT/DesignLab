...
window.AGENT_PROMPT = [
  ...
  "  git add js/data.js and any batch or script files you touched",
  ...
  "If the rebase conflicts inside items[] (or a batch), another agent appended at the same spot: keep BOTH blocks of entries, fix commas until the file parses, node --check again, then git rebase --continue and push. If anything goes sideways, git rebase --abort and report back instead of improvising.",
  "",
