...
window.AGENT_PROMPT = [
  ...
  "  }",
  "",
  "Before inventing anything, fetch https://mrwillist.github.io/DesignLab/js/data.js (or open the live site) and read the drawer you are expanding so you never duplicate an existing specimen.",
  "",
  "COMPETITION",
  ...
  "1. Study the drawer first. Fetch https://mrwillist.github.io/DesignLab/js/data.js (or open the live site) and read every specimen already in the section before inventing anything. If your toolset genuinely cannot fetch either, say so in one line, then proceed with extra care about structural difference.",
